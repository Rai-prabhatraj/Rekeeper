...
const menu = (
  <Menu onClick={onClick}>
    ...
    <Menu.Item key="2">Diabetes Test</Menu.Item>
    <Menu.Item key="3">Kidney Check</Menu.Item>
  </Menu>
);
        ...
        <ProtectedRoute exact path="/home/entityHome/Profile">
          <ActionPageLayout
            ...
            content={
              <EntityProfile
                fullname="Ankur"
                hospital="Bhilai Hospital"
                address="QNO.11,STREET 1"
                id="200123"
